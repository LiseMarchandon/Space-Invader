...
class Missile:
    ...
    def setPos(self, x, y):
        ...
        """
        cette méthode permet de modifier la position du missile
        entrées: coordonnées x et y et l'objet en question
        sorties: pas de sortie
        """
    ...
    def isAlive(self):
        ...
        entrée: objet missile
        sorties: True (boolean) si le missile est vivant
        """
    ...
    def collisionJoueur(self, vaisseau):
        ...
        """
        cette méthode permet de definir lorsque le joueur est atteint par un missile de l'ennemie
        entrées: objet missile, joueur
        sorties: pas de sortie 
        """
    ...
    def collisionShield(self):
        ...
        """
        cette méthode permet de definir lorsqu'un bouclier est atteint par un missile (que ce soit de l'ennemie ou du joueur)
    ...
    def detruireEnnemy(self, img):
        ...
        """
        cette méthode permet d'éliminer l'image de l'ennemie lorsque celui-ci est atteint par un missile
